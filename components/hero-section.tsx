...
const slides = [
  {
    ...
    descriptionKey: "home.hero.description1",
  ...
  },
  {
    ...
    descriptionKey: "home.hero.description2",
    link: "/transport#vip",
  },
  {
    image:
    ...
    descriptionKey: "home.hero.description3",
  ...
  },
  {
    ...
    descriptionKey: "home.hero.description4",
    link: "/tourist",
  },
]
    ...
    <section className="relative w-full h-[85vh] min-h-[500px] max-h-[900px] overflow-hidden">
      <AnimatePresence mode="wait">
        ...
        >
          ...
          />
          <div
            className={`absolute inset-0 ${language === "ar" ? "bg-gradient-to-l" : "bg-gradient-to-r"} from-black/60 via-black/40 to-transparent`}
          />
        </motion.div>
      </AnimatePresence>

      <div
        className={`container relative h-full flex flex-col justify-center px-4 md:px-6 ${language === "ar" ? "items-end text-right" : "items-start text-left"}`}
      >
        <AnimatePresence mode="wait">
          <motion.div
            key={currentSlide}
            ...
            >
              ...
              >
                <Link href={slides[currentSlide].link}>
                  {t("common.discover")}
                  <ChevronRight
                    className={`${language === "ar" ? "mr-2 rotate-180" : "ml-2"} h-5 w-5 transition-transform duration-300 group-hover:${language === "ar" ? "-translate-x-1" : "translate-x-1"}`}
                  />
                </Link>
              </Button>
              <Button
