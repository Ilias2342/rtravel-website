  ...
  return (
    <>
      {isDialogOpen && (
        <SEO
          type="vehicle"
          title={`${name} - Location de ${type} au Maroc | R'TRAVEL`}
          description={`Réservez ${name} pour votre séjour au Maroc. ${description.substring(0, 100)}...`}
          data={{ name, imageUrl, description, pricePerDay }}
        />
      )}
      <motion.div
      ...
      >
        ...
        >
          <div className="relative h-56 w-full overflow-hidden">
            ...
            <Badge
              variant="outline"
              className="absolute top-3 right-3 bg-black/50 text-white border-0 backdrop-blur-sm"
            >
